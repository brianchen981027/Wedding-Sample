...
const Details = () => {
  return (
    <div
      className="bg-secondaryBg/60 max-h-[480px] lg:px-[5%] py-[10%] flex flex-col items-center justify-center"
      id="details"
    >
      ...
      <div className="flex w-full mt-[5%] justify-between">
        ...
        <div className="flex flex-col justify-center w-full sm:w-[75vw] md:w-[50vw]">
          ...
          <div className="flex justify-between mb-4">
            ...
            <div className="w-px h-[30px] bg-gray-500 mx-10 hidden lg:block" />
            <h5 className="text-[16px] text-primary text-center sm:text-[18px] md:text-[20px] ">
              精彩表演
            </h5>
          </div>
